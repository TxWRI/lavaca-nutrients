...
```{r}
#| echo: false
#| tbl-cap: "Summary of goodness-of-fit metrics for 5-fold cross-validation of NO~3~-N GAM at Lavaca River at Edna, USGS-08164000."
...
```{r}
#| echo: false
#| tbl-cap: "Summary of goodness-of-fit metrics for 5-fold cross-validation of TP load GAM at Lavaca River at Edna, USGS-08164000."
...
```{r}
#| echo: false
#| tbl-cap: "Summary of goodness-of-fit metrics for 5-fold cross-validation of NO~3~-N concentration GAM at Navidad River at Strane Pk nr Edna,, USGS-NO308164390."
...
```{r}
#| echo: false
#| tbl-cap: "Summary of goodness-of-fit metrics for 5-fold cross-validation of TP load GAM at Navidad River at Strane Pk nr Edna, USGS-08164390."
...
```{r}
#| echo: false
#| tbl-cap: "Summary of goodness-of-fit metrics for 5-fold cross-validation of NO~3~-N concentration GAM at Sandy Creek nr Ganado, USGS-08164450."
...
```{r}
#| echo: false
#| tbl-cap: "Summary of goodness-of-fit metrics for 5-fold cross-validation of TP load GAM at Sandy Creek nr Ganado, USGS-08164450."
...
```{r}
#| echo: false
#| tbl-cap: "Summary of goodness-of-fit metrics for 5-fold cross-validation of NO~3~-N load GAM at E Mustang Creek nr Louise, USGS-08164504."
...
```{r}
#| echo: false
#| tbl-cap: "Summary of goodness-of-fit metrics for 5-fold cross-validation of TP load GAM at E Mustang Creek nr Louise, USGS-08164504."
...
```{r}
#| echo: false
#| tbl-cap: "Summary of goodness-of-fit metrics for 5-fold cross-validation of NO~3~-N load GAM at W Mustang Creek nr Ganado, USGS-08164503."
...
```{r}
#| echo: false
#| tbl-cap: "Summary of goodness-of-fit metrics for 5-fold cross-validation of TP load GAM at W Mustang Creek nr Ganado, USGS-08164503."
...
```{r}
#| echo: false
#| tbl-cap: "Summary of goodness-of-fit metrics for 5-fold cross-validation of NO~3~-N load GAM at Palmetto Bend Dam."
...
gratia::add_fitted(data = data,
  ...
  scale_y_continuous(trans = scales::pseudo_log_trans(0.1, 1000000), 
                     breaks = scales::log_breaks(base = 10), 
                     expand = c(0, 0)) +
  labs(y = "NO<sub>3</sub> [kg/day]", x = "Date") +
  theme_TWRI_print() +
  theme(axis.title.y = element_markdown(),
        legend.title = element_blank(),
        legend.text = element_markdown())
...
```{r}
#| echo: false
#| tbl-cap: "Summary of goodness-of-fit metrics for 5-fold cross-validation of TP GAM at Palmetto Bend Dam."
