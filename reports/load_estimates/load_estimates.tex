...
for each respective time period. Mean annual yields (daily load
normalized by drainage area) were also calculated from daily load
predictions to permit comparisons with other studies.
