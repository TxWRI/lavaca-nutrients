...
```{r}
#| fig-cap: "Watershed plans and TMDLs for indicator bacteria in FW streams."
#| out-width: 80%
knitr::include_graphics("images/lbwpp.png")
```
...
```{r}
#| fig-cap: "Persistant mercury contamination at shuttered industrial sites. Image by Kimiko Fieg [@priestDecadesLaterMercury2018]."
#| out-width: 80%
knitr::include_graphics("images/mercury.png")
```
